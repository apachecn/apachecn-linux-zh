...
也建立了`initramfs`图像。一个名为`update-initramfs`的 Shell 脚本执行这个任务(它本身是另一个名为`mkinitramfs(8)`的脚本的便利包装器，该脚本执行实际工作)。构建完成后，`initramfs`图像也被复制到`/boot`目录中，如前面输出片段中的`initrd.img-5.4.0-llkd01`所示。
...
![](img/b48ca480-e208-45e4-b413-e7a0a09dcac5.png)
...
![](img/98cb4ded-7d3d-452d-9fb8-f4ddc98309bf.png)
...
![](img/9a8b91db-e737-4c3b-a497-41138280e0a4.png)
...
![](img/b4d2a648-4e20-4ca2-ae63-a8e2caa71bc8.png)
...
![](img/1dc4a4b5-e6bb-4a2e-9ba8-e17968a7436b.png)
...
现在，当你启动时，内核启动到单用户模式，并给你，永远感激的用户，*一个带根访问的 Shell*。只需运行`passwd <username>`命令即可更改您的密码。
...
![](img/f2a2d45c-8cb6-47c9-a4c7-d6a1cca4f57c.png)
