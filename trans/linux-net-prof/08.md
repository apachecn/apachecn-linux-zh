...
![Figure 8.1 – Certificate signing request (CSR) and issuing a certificate ](Images/B16336_08_001.jpg)
...
![Figure 8.2 – TLS communication starts with a client hello ](Images/B16336_08_002.jpg)
...
![Figure 8.3 – TLS exchange: server hello is sent and certificate is validated by the client ](Images/B16336_08_003.jpg)
...
![Figure 8.4 – Client key exchange and the server gets one last chance to change the cipher ](Images/B16336_08_004.jpg)
...
![Figure 8.5 – Negotiation is complete and communication proceeds using the master secret (key) for encryption ](Images/B16336_08_005.jpg)
