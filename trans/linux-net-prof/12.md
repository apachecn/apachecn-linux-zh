...
![](Images/B16336_12_Table_02a.jpg)

![](Images/B16336_12_Table_02b.jpg)
...
![Figure 12.1 – Dshield data for one port](Images/B16336_12_001.jpg)
...
在你可以在 Linux 下执行命令行查询之前，你可能需要安装`snmp`包:
...
![Figure 12.2 – SNMP OID tree, showing mib-2](Images/B16336_12_002.jpg)
...
![Figure 12.3 – SNMP OID tree, showing interface information (ifTable)](Images/B16336_12_003.jpg)
...
![Figure 12.4 – SNMP OID tree, showing the Vendor OID section](Images/B16336_12_004.jpg)
...
![Figure 12.5 – LibreNMS Edit Dashboard startup screen](Images/B16336_12_005.jpg)

图 12.5 - LibreNMS Edit Dashboard 启动界面

在你继续之前，点击屏幕右上方的`librenms`帐户图标:

![Figure 12.6 – LibreNMS "Account" and "System" icons](Images/B16336_12_006.jpg)

图 12.6 - LibreNMS“帐户”及“系统”图标

然后，更新网络帐户的密码:

![Figure 12.7 – Changing default passwords in LibreNMS](Images/B16336_12_007.jpg)
...
![Figure 12.8 – Adding a device to LibreNMS](Images/B16336_12_008.jpg)

图 12.8 -向 LibreNMS 添加设备

填写设备的 IP 地址，以及团体字串。 你的屏幕应该看起来像这样(当然是你自己设备的 IP地址):

![Figure 12.9 – Adding device details in LibreNMS](Images/B16336_12_009.jpg)
...
![Figure 12.10 – Device statistics collected in LibreNMS](Images/B16336_12_010.jpg)
...
![Figure 12.11 – Mousing over an interface for interface details in LibreNMS](Images/B16336_12_011.jpg)
...
![Figure 12.12 – Adding a device to the LibreNMS inventory using SNMPv3](Images/B16336_12_012.jpg)
...
![Figure 12.13 – Changing the device's name and adding an "Overwrite IP" in LibreNMS](Images/B16336_12_013.jpg)
...
![Figure 12.14 – Default alert collection in LibreNMS ](Images/B16336_12_014.jpg)

图 12.14 - LibreNMS 中的默认警报集合

让我们添加一个警报，它将在利用率超过 80%的任何接口上触发。 要查看默认集合中是否有类似这样的内容，请在*Search*字段中输入`utili`—当你输入时，搜索范围会缩小:

![Figure 12.15 – Adding an alert in LibreNMS ](Images/B16336_12_015.jpg)

图 12.15 -在 LibreNMS 中添加警报

选择规则; 我们将得到一些选项:

![Figure 12.16 – Alert rule options in LibreNMS ](Images/B16336_12_016.jpg)
...
![Figure 12.17 – Matching devices and groups within an alert rule in LibreNMS ](Images/B16336_12_017.jpg)
...
![Figure 12.18 – Syslog display in LibreNMS ](Images/B16336_12_018.jpg)
...
![Figure 12.19 – Monitoring a basic service in LibreNMS ](Images/B16336_12_019.jpg)
...
![Figure 12.20 – Monitoring an HTTPS service in LibreNMS using parameters ](Images/B16336_12_020.jpg)
...
![Figure 12.21 – Services display in LibreNMS ](Images/B16336_12_021.jpg)

图 12.21 - LibreNMS 中显示的服务

可用的插件的完整列表可以直接从**服务配置**页面的下拉菜单中看到:

![Figure 12.22 – Service checks available in LibreNMS ](Images/B16336_12_022.jpg)

图 12.22 - LibreNMS 中可用的服务检查

一些常用的检查包括以下:

![](Images/B16336_12_Table_06.jpg)
...
![Figure 12.23 – Basic flow data in the graph display with display/filter controls in NFSen ](Images/B16336_12_023.jpg)
...
![Figure 12.24 – Flow display controls for aggregation and filtering in NFSen ](Images/B16336_12_024.jpg)
...
![Figure 12.25 – Filter results in NFSen ](Images/B16336_12_025.jpg)
...
![Figure 12.26 – Unusual traffic "peak" discovered ](Images/B16336_12_026.jpg)

图 12.26 -发现异常流量“峰值

让我们将将更改为协议显示，并稍微讨论一下。 在这个显示中，我们已经削减了只显示 UDP 的东西，我们可以看到一些可疑的东西-这个 UDP 流量是不正常的组织:

![Figure 12.27 – Display adjustments in the protocol display, showing UDP only ](Images/B16336_12_027.jpg)

图 12.27 -在协议显示中显示调整，只显示 UDP

由于和在 14:20 出现了可疑的流量高峰，让我们深入挖掘一下。 让我们添加一个 nfdump 过滤器来查看 UDP，但是取出所有我们在内部 DNS 服务器上配置的 DNS 转发器的请求:

![Figure 12.28 – UDP search results – removing legitimate DNS traffic ](Images/B16336_12_028.jpg)

图 12.28 - UDP 搜索结果-删除合法的 DNS 流量

现在，深入挖掘，让我们看看这个可疑 IP 地址:

![Figure 12.29 – Filtering for a suspect IP address ](Images/B16336_12_029.jpg)

图 12.29 -过滤可疑 IP 地址

这给了我们以下的结果，显示了在防火墙上 NAT 转换前后相同的传输，除了这一次大的数据传输之外没有其他流量:

![Figure 12.30 – Suspect traffic before and after NAT on the firewall ](Images/B16336_12_030.jpg)
