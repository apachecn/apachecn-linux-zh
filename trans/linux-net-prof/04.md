...
![Figure 4.1 – Linux as a perimeter firewall ](Images/B16336_04_001.jpg)

图 4.1 - Linux 作为外围防火墙

让我们说得更具体一点。 我们将添加一个主机`192.168.10.10`，该主机向`8.8.8.8`发出 DNS 查询:

![Figure 4.2 – Perimeter firewall example, showing NAT and state (session tracking or mapping) ](Images/B16336_04_002.jpg)
...
![Figure 4.3 – Order of operation in iptables ](Images/B16336_04_003.jpg)
