...
安全洋葱安装，默认情况下，安装 Suricata 和 Zeek，所以在一个较小的环境中，这是很有意义的，而且，它是方便的从这两个应用程序的信息在同一台主机上。
...
![Figure 13.38 – Other internal hosts with the same suspicious traffic](Images/B16336_13_038.jpg)
