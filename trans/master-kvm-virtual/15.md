...
![Figure 15.1 – A PCI Express riser for DL380p G8 – you have to insert your  PCI Express cards into its slots ](image/B14834_15_01.jpg)
...
1.  Execute `virsh nodeinfo` to gather details about the host CPU configuration:
    ...
    ![Figure 15.2 – Information about our KVM node ](image/B14834_15_02.jpg)
...
2.  The next step is to get the CPU topology by executing the `virsh capabilities` command and check the section tagged `<topology>`:
    ...
    ![Figure 15.3 – The virsh capabilities output with all the visible physical CPU cores ](image/B14834_15_03.jpg)
...
3.  Let's first check the current affinity or pinning configuration with the guest named `SQLForNuma`, which has four vCPUs:
    ...
    ![Figure 15.4 – Checking the default vcpupin settings ](image/B14834_15_04.jpg)
...
4.  Let's pin `vCPU0` to physical core 0, `vCPU1` to physical core 1, `vCPU2` to physical core 2, and `vCPU3` to physical core 3:
    ...
    ![Figure 15.5 – Configuring CPU pinning ](image/B14834_15_05.jpg)
...
![Figure 15.6 – CPU pinning VM configuration changes ](image/B14834_15_06.jpg)
...
![Figure 15.7 – virsh vcpuinfo for our VM ](image/B14834_15_07.jpg)
 ...
 **![Figure 15.8 – VM memory options ](image/B14834_15_08.jpg)
...
![Figure 15.9 – Checking the memtune settings for the VM ](image/B14834_15_09.jpg)
...
![Figure 15.10 – Checking virsh help memtune ](image/B14834_15_10.jpg)
...
![Figure 15.11 – Checking the HugePages settings ](image/B14834_15_11.jpg)
...
2.  We can also use the `sysctl -a |grep huge` command:
    ...
    ![Figure 15.12 – The sysctl hugepages settings ](image/B14834_15_12.jpg)
...
![Figure 15.13 – Checking the KSM settings ](image/B14834_15_13.jpg)
...
![Figure 15.14 – The KSM settings in sysfs ](image/B14834_15_14.jpg)
...
![Figure 15.15 – The ksm service command and the ps command output ](image/B14834_15_15.jpg)
...
![Figure 15.16 – The numactl -H output ](image/B14834_15_16.jpg)
...
![Figure 15.17 – The lstopo command to visualize the NUMA topology ](image/B14834_15_17.jpg)
...
![Figure 15.18 – Using virsh numatune to configure the NUMA settings ](image/B14834_15_18.jpg)
...
![Figure 15.19 – The numactl hardware output ](image/B14834_15_19.jpg)
...
![Figure 15.20 – Checking whether numad is active ](image/B14834_15_20.jpg)

图 15.20-检查 Numad 是否处于活动状态

一旦执行了`numad`二进制文件，它将开始对齐，如下面的屏幕截图所示。 在我们的系统中，我们运行以下虚拟机：

![Figure 15.21 – Listing running VMs ](image/B14834_15_21.jpg)
...
![Figure 15.22 – The numastat command output for the qemu-kvm process ](image/B14834_15_22.jpg)
...
![Figure 15.23 – The Virtio architecture ](image/B14834_15_23.jpg)
...
![Figure 15.24 – Excerpt from the virsh blkdeviotune –help command ](image/B14834_15_24.jpg)
...
![Figure 15.25 – The vhost_net architecture ](image/B14834_15_25.jpg)
...
![Figure 15.26 – Checking vhost kernel modules ](image/B14834_15_26.jpg)
