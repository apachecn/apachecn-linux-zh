...
![Figure 2.1 – Physical server ](image/B14834_02_01.jpg)

图 2.1-物理服务器

在虚拟化世界中，我们运行的是虚拟机管理程序(如 KVM)，虚拟机位于该虚拟机管理程序之上。 在这些虚拟机中，我们运行相同的操作系统和应用程序，就像在物理服务器中一样。 虚拟化方法如下图所示：

![Figure 2.2 – Hypervisor and two virtual machines ](image/B14834_02_02.jpg)
...
![Figure 2.3 – Protection rings (source: https://en.wikipedia.org/wiki/Protection_ring) ](image/B14834_02_03.jpg)
...
![Figure 2.4 – System call to supervisor mode ](image/B14834_02_04.jpg)
...
![Figure 2.5 – Binary translation ](image/B14834_02_05.jpg)

图 2.5-二进制转换

使用这种方法，关键指令被发现(在运行时静态或动态地)，并替换为 VMM 中的陷阱，这些陷阱将在软件中仿真。 与在本地虚拟化架构上运行的虚拟机相比，二进制转换可能会带来很大的性能开销。 这可以在下图中看到：

![Figure 2.6 – Full virtualization ](image/B14834_02_06.jpg)
...
![Figure 2.7 – Paravirtualization ](image/B14834_02_07.jpg)
...
![Figure 2.8 – Hardware-assisted virtualization ](image/B14834_02_08.jpg)
...
![Figure 2.9 – QEMU source content, downloaded via Git ](image/B14834_02_09.jpg)
...
![Figure 2.10 – Driver-based architecture ](image/B14834_02_10.jpg)
...
OnDevice 应用程序获取到虚拟机管理程序的 virConnectPtr 连接，然后可用于管理虚拟机管理程序的可用域和相关虚拟化资源(如存储和网络)。所有这些资源都公开为第一类对象，并连接到虚拟机管理程序连接(以及可用的节点或群集)。

下图显示了 API 导出的五个主要对象以及它们之间的连接关系：

![Figure 2.11 – Exported API objects and their communication ](image/B14834_02_11.jpg)
...
![Figure 2.12 – libvirt source code ](image/B14834_02_12.jpg)
...
![Figure 2.13 – TCG in QEMU ](image/B14834_02_13.jpg)
...
![Figure 2.14 – QEMU as a virtualizer ](image/B14834_02_14.jpg)
...
![Figure 2.15 – QEMU source code ](image/B14834_02_15.jpg)
...
![Figure 2.16 – KVM guest ](image/B14834_02_16.jpg)
