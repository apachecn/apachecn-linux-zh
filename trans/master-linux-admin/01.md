...
安装后，Ubuntu作为一个传统的 Windows 桌面命令行应用运行。
...
不同的高级用户可能会寻找特定类别的应用、工具或实用程序。 下面是 Linux 用户社区使用的几种最常见的生产力工具和应用。 其中一些可以通过*Ubuntu Software*package管理界面下载。 其他的可以从相关的供应商网站下载。
