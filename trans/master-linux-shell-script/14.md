...
![](Images/f6f4a369-5ad2-417f-b7f3-c8c5d2f9c8f4.png)
...
![](Images/244aaa63-2f2c-41d0-a43b-db41ce9bb335.png)

为了结束这一节的 Python 描述，我们应该看一下 Python 的禅。 在 REPL 中，我们可以输入`import this`，如下截图所示:

![](Images/ee86f25a-9032-4709-918a-7890a7e289aa.png)
...
![](Images/9f8f5f9c-a8b6-49eb-a3ef-71fe4a6f2b59.png)
...
![](Images/14f2ceb6-5e31-4896-a472-2e53ee8febc5.png)
...
![](Images/586821ef-3beb-4361-ba75-a15d1f8a3c39.png)

如果我们尝试运行脚本并忽略提供参数，那么当我们引用索引`1`时，数组中将会有一个空值。 这将给出一个错误，如下面的截图所示:

![](Images/3bcebb19-f36c-4b3e-8385-92cda7f2c297.png)
...
![](Images/c2073b52-8953-4dfe-979d-8873f725f54a.png)
...
你可以看到这是一个简单的任务; 这就是为什么 Python 在许多应用程序中被使用，并且在学校中被广泛教授。
...
![](Images/409cba04-6f75-4ced-a2a0-f51c08178b79.png)
...
![](Images/7d996f4c-71ac-4faa-8e65-b408841d8ae5.png)
...
![](Images/ad30521f-0df5-49e6-b500-1f411b6ede49.png)

要改变字符大小写，可以使用`upper()`和`lower()`函数:

![](Images/2da7c9f9-6718-4ff1-914d-505e3c3f3fca.png)
