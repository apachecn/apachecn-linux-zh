...
![Sed – one-liner productivity treasure](graphics/image_04_001.jpg)
...
*   `l`: means case insensitive search.
    ...
    ![Sed – one-liner productivity treasure](graphics/image_04_002.jpg)
...
![Sed – one-liner productivity treasure](graphics/image_04_003.jpg)

如果我们检查文件的内容，可以看到初始文件包含更新后的文本，备份文件包含原始文本。

现在，让我们看一个更实际的例子。假设我们有一个包含多个变量的 shell 脚本，我们希望用花括号将变量括起来:

![Sed – one-liner productivity treasure](graphics/image_04_004.jpg)
...
*   `\1`: The string that was previously matched in the ( )
    ...
    ![Sed – one-liner productivity treasure](graphics/image_04_005.jpg)
...
*   `<b\1b>`: Just add `<b b>`, and the text that you previously found in the `( )`.
    ...
    ![Sed – one-liner productivity treasure](graphics/image_04_006.jpg)

如您所见，文本更新正确，`red`类仍然适用于新标签，旧文本仍然包含在我们的标签之间，这正是我们想要的:

![Sed – one-liner productivity treasure](graphics/image_04_007.jpg)
...
![Sed – one-liner productivity treasure](graphics/image_04_008.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_009.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_010.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_011.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_012.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_013.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_014.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_015.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_016.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_017.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_018.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_019.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_020.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_021.jpg)
...
*   The above will merge all our lines with the `+` sign as a delimiter. This, of course, can translate to an arithmetic operation, which we can calculate using the binary calculator (`bc`):
    ...
    ![You can run, but you can't hide… from find](graphics/image_04_022.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_023.jpg)
...
![You can run, but you can't hide… from find](graphics/image_04_024.jpg)
...
![tmux – virtual consoles, background jobs and the like](graphics/image_04_025.jpg)
...
![tmux – virtual consoles, background jobs and the like](graphics/image_04_026.jpg)

你会发现自己置身于一个全新的虚拟控制台中:

![tmux – virtual consoles, background jobs and the like](graphics/image_04_027.jpg)

出于演示目的，我们将打开一个新的选项卡，您可以使用`tmux ls`查看打开的会话列表:

![tmux – virtual consoles, background jobs and the like](graphics/image_04_028.jpg)
...
![tmux – virtual consoles, background jobs and the like](graphics/image_04_029.jpg)
...
![tmux – virtual consoles, background jobs and the like](graphics/image_04_030.jpg)
...
![tmux – virtual consoles, background jobs and the like](graphics/image_04_031.jpg)

这将终止正在运行的会话。如果我们切换到第二个选项卡，我们可以看到我们已经注销了 tmux。让我们也关闭这个终止符选项卡，并打开一个全新的 tmux 会话:

![tmux – virtual consoles, background jobs and the like](graphics/image_04_032.jpg)

Tmux 给你分屏的可能性，就像终结者一样，水平用 *Ctrl* + *b* +”，垂直用*Ctrl*+*b*+*%*。之后，使用 *Ctrl* + *b* +箭头在窗格之间导航:

![tmux – virtual consoles, background jobs and the like](graphics/image_04_033.jpg)

您还可以创建窗口(标签):

*   *Ctrl* + *b c*: create:

    ![tmux – virtual consoles, background jobs and the like](graphics/image_04_034.jpg)

*   *Ctrl* + *b w*: list:

    ![tmux – virtual consoles, background jobs and the like](graphics/image_04_035.jpg)

*   *Ctrl* + *b &*: delete

    ![tmux – virtual consoles, background jobs and the like](graphics/image_04_036.jpg)
...
![Network – Who's listening?](graphics/image_04_037.jpg)
...
![Network – Who's listening?](graphics/image_04_038.jpg)
...
![Network – Who's listening?](graphics/image_04_039.jpg)
...
![Network – Who's listening?](graphics/image_04_040.jpg)
...
![Network – Who's listening?](graphics/image_04_041.jpg)
...
![Network – Who's listening?](graphics/image_04_042.jpg)

Nmap 是用于检查远程主机上所有打开端口的命令，也称为端口扫描程序。如果我们在我们的网络网关上运行`nmap`，在我们的例子中是`192.68.0.1`，我们将获得网关上所有打开的端口:

类型: **nmap 192.168.0.1**

![Network – Who's listening?](graphics/image_04_043.jpg)
...
![Network – Who's listening?](graphics/image_04_044.jpg)
...
![Network – Who's listening?](graphics/image_04_045.jpg)
...
![Network – Who's listening?](graphics/image_04_046.jpg)
...
![Autoenv – Set a lasting, project-based habitat](graphics/image_04_047.jpg)
...
![Autoenv – Set a lasting, project-based habitat](graphics/image_04_048.jpg)
...
![Autoenv – Set a lasting, project-based habitat](graphics/image_04_049.jpg)

现在让我们将目录更改为`project 2`:

![Autoenv – Set a lasting, project-based habitat](graphics/image_04_050.jpg)
...
![Autoenv – Set a lasting, project-based habitat](graphics/image_04_051.jpg)

一切似乎都很好，所以让我们进入我们的文件夹:

![Autoenv – Set a lasting, project-based habitat](graphics/image_04_052.jpg)

如您所见，环境变量已经设置:

![Autoenv – Set a lasting, project-based habitat](graphics/image_04_053.jpg)
...
![Don't rm the trash](graphics/image_04_054.jpg)
...
![Don't rm the trash](graphics/image_04_055.jpg)
...
![Don't rm the trash](graphics/image_04_056.jpg)
...
![Don't rm the trash](graphics/image_04_057.jpg)
...
![Don't rm the trash](graphics/image_04_058.jpg)
