...
![Supercharging Vim](graphics/image_03_001.jpg)
...
![Supercharging Vim](graphics/image_03_002.jpg)
...
![Color scheme desert](graphics/image_03_003.jpg)
...
![Color scheme desert](graphics/image_03_004.jpg)
...
![Keyboard kung fu](graphics/image_03_005.jpg)
...
![Keyboard kung fu](graphics/image_03_006.jpg)
...
![Keyboard kung fu](graphics/image_03_007.jpg)
...
![Keyboard kung fu](graphics/image_03_008.jpg)
...
![Keyboard kung fu](graphics/image_03_009.jpg)

![Keyboard kung fu](graphics/image_03_010.jpg)
...
![Keyboard kung fu](graphics/image_03_011.jpg)
...
![Keyboard kung fu](graphics/image_03_012.jpg)

打开`sort.txt`和`run :sort`。我们看到这些行都是按字母顺序排序的。

![Keyboard kung fu](graphics/image_03_013.jpg)

现在让我们继续前进到窗口管理。Vim 可以选择分割屏幕来并行编辑文件。水平拆分只需写`:split`，垂直拆分只需写`:vsplit`:

![Keyboard kung fu](graphics/image_03_014.jpg)

![Keyboard kung fu](graphics/image_03_015.jpg)
...
![Keyboard kung fu](graphics/image_03_016.jpg)
...
![Plugin steroids for Vim](graphics/image_03_017.jpg)
...
![Plugin steroids for Vim](graphics/image_03_018.jpg)
...
![Plugin steroids for Vim](graphics/image_03_019.jpg)
...
![Plugin steroids for Vim](graphics/image_03_020.jpg)
...
![Vim password manager](graphics/image_03_021.jpg)
...
![Vim password manager](graphics/image_03_022.jpg)

使用 Vim 保存加密文件，结合在私有`git`存储库或私有 Dropbox 文件夹等地方备份文件，可以成为存储密码的有效方式:

![Vim password manager](graphics/image_03_023.jpg)
...
![Instant configuration restoring](graphics/image_03_025.jpg)
