...
在本章的前面，我说过我不会说我更喜欢这两个 MAC 系统中的哪一个。如果你现在还没想明白，我绝对是 SELinux 的忠实粉丝，因为它提供了比 AppArmor 更好的开箱即用保护。如果您选择使用 Ubuntu，那么在您的开发团队部署新应用程序的任何时候，都要计划编写一个新的 AppArmor 策略。
