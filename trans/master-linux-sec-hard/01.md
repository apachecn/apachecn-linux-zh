...
![](assets/cf1f3c4e-4f5c-467f-ab1c-1d6ecf32cbe3.png)

4.  启动新的虚拟机。点击对话框左下角的文件夹图标，导航到您存储下载的`.iso`文件的目录。选择 Ubuntu 国际标准化组织文件或 CentOS 国际标准化组织文件，如下图所示:

![](assets/4899c866-cd76-41c8-87ce-e369fa51e344.png)
...
![](assets/0a676898-f36c-4356-80b2-64e21c38db73.png)
...
![](assets/eb423f86-39cf-44df-bc1e-92be2cf67ae6.png)

4.  展开“高级”项目，并将“混杂模式”设置更改为“允许全部”，如下图所示:

![](assets/bf638094-f11a-4ce4-90a0-474c96a61eb2.png)
...
![](assets/1af6ee15-d6ea-4fc0-8832-29fce45254a0.png)
...
![](assets/69bbab3b-4fb0-4af6-9655-7673d1095b09.png)

5.  向下滚动，直到看到 openssh 包。在“新建”列下，单击“跳过”(这将导致出现一个版本号来代替“跳过”)，如下图所示:

![](assets/36eb5427-bae5-45d8-b07f-79bf96beb6a3.png)

6.  选择合适的软件包后，您的屏幕应该如下所示:

![](assets/e5e8c35f-63ec-45e0-b5cb-fa48ce7a61b5.png)
...
![](assets/1c121c39-8bf6-499f-a772-c8f50b391e77.png)

2.  然后，只需像在 Mac 或 Linux 机器上一样输入 SSH 命令，如下所示:

![](assets/09afc49f-0d40-43bc-9458-10beda86b3ed.png)

3.  更好的选择是使用 Windows PowerShell，而不是普通的命令提示符。就像你在这里看到的:

![](assets/101d3671-43a4-4ad8-bcde-42e1c83cf8ae.png)

4.  和以前一样，让我们用它来登录我的 Orange Pi 设备，如下所示:

![](assets/e5054559-f8f5-45e0-8955-9ad97a3150d8.png)
...
![](assets/fec93350-5189-4a2e-8827-1e1f2c4a91d4.png)
...
![](assets/731c6496-6f72-4cf1-89a8-82bb6d6b5acb.png)
...
![](assets/78d5abc0-30e0-450e-9f10-09e458075e5b.png)
