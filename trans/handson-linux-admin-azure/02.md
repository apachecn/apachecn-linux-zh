...
![The output showing the subscription details on the command prompt in JSON format](image/B15455_02_01.jpg)

###### 图 2.1:JSONC 格式的订阅细节

**tab 分隔值**(**TSV**)是一个好主意，如果输出是单个值，如果你想使用文本过滤工具，如 AWK，或者如果你想将输出导出到电子表格:

![The output showing the subscription details on the command prompt separated by Tabs](image/B15455_02_02.jpg)

###### 图 2.2:tab 分隔的订阅详细信息

表的输出非常易读，但比默认输出有更多限制:

![The output showing the subscription details on the command prompt in table format](image/B15455_02_03.jpg)
...
![To provide username and password in Powershell for your virtual machine](image/B15455_02_04.jpg)
...
![The list of various image publishers and their location in Powershell](image/B15455_02_05.jpg)
...
![The list of various image publishers and their location in Bash](image/B15455_02_06.jpg)
...
![Selecting Canonical as the publisher and selecting offers for it in Powershell](image/B15455_02_07.jpg)
...
![The list of various SKUs offered by Canonical publisher for UbuntuServer](image/B15455_02_08.jpg)
...
![Version detail of the available image using publisher's name, offer and SKUs in Azure CLI](image/B15455_02_09.jpg)
...
![Creating a new virtual machine with a size of Standard_A1 by instructing Powershell to use image version](image/B15455_02_10.jpg)
...
![The output displaying private IP address of virtual machines in a resource group in JSON format](image/B15455_02_11.jpg)
...
![Command to see the storage profile of SUSE virtual machine](image/B15455_02_12.jpg)
...
![Creation of SSH key pair using ssh-keygen command](image/B15455_02_13.jpg)
