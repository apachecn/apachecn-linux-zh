...
![Navigating within the Dashboard to create and download VM as a template](image/B15455_07_01.jpg)

###### 图 7.1:下载 VM 作为模板

点击**下载自动化模板**，会看到如下画面:

![Adding script to the library within the template pane](image/B15455_07_02.jpg)
...
![Navigating on Visual Studio Code for installing Azure Resource Manager Tools](image/B15455_07_03.jpg)
...
![Saving templates to the library using ARM Visualizer](image/B15455_07_04.jpg)

###### 图 7.4:将模板保存到库

如本窗格所述，您可以通过使用左侧导航栏中的**所有资源**轻松地在 Azure 门户中导航，并搜索模板:

![Navigating to the templates on the Azure portal](image/B15455_07_05.jpg)
...
![Redeploying the VM using the JSON files](image/B15455_07_06.jpg)
...
![Checking logs to verify nginx installation](image/B15455_07_07.jpg)
...
![Verifying the vagrant installation using the version command](image/B15455_07_10.jpg)
...
![Deploying the vagrant box using the up command](image/B15455_07_11.jpg)
...
![Deploying the VM again to make Vagrant take the SSH key and start the provisioning](image/B15455_07_12.jpg)
...
![Verifying packer installation through Packer version ](image/B15455_07_13.jpg)
...
![Building the image using the Packer build command](image/B15455_07_14.jpg)
...
![Image summary provided by Packer, once build is complete](image/B15455_07_15.jpg)
...
3.  Log in to the VM and deprovision it using the Azure VM Agent. It generalizes the VM by removing user-specific data:
    ...
    ![ Deprovisioning the VM using VM Agent](image/B15455_07_16.jpg)
...
7.  Verify the result:
    ...
    ![List of Azure images in tablular format](image/B15455_07_17.jpg)
...
![Summary of the image details obtained using Get-AzImage –ImageName command](image/B15455_07_18.jpg)
