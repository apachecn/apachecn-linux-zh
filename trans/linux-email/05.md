...
![Installing Cyrus SASL](graphics/8648_05_1.jpg)
...
当 Cyrus SASL 收到应用程序名称时，它将追加一个 `.conf`并开始寻找包含配置设置的配置文件。
...
![Testing Cyrus SASL authentication](graphics/8648_05_2.jpg)
...
![Enabling Transport Layer SecuritySASL layerplaintext mechanism](graphics/8648_05_3.jpg)
